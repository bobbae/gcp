...
def train_and_evaluate(hparams):
    ...
    exporter = tf.estimator.FinalExporter(
        'crypto', model.SERVING_FUNCTIONS[hparams.export_format])
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        nargs='+',
        default='gs://kubeflow-ekaba-bucket/transformed-crypto-bitcoin-00-of-02.csv')
    parser.add_argument(
        '--eval-files',
        help='GCS file or local paths to evaluation data',
        nargs='+',
        default='gs://kubeflow-ekaba-bucket/transformed-crypto-bitcoin-01-of-02.csv')
    parser.add_argument(
        '--job-dir',
        help='GCS location to write checkpoints and export models',
        default='/tmp/crypto-estimator')
    parser.add_argument(
        '--num-epochs',
        help="""\
